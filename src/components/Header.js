    ...
    return (
        <div>
            <div className="flex justify-around p-2 bg-orange-100">
                <div>
                    <a href="/"><img className="w-40 rounded-md cursor-pointer" src="https://plus.unsplash.com/premium_photo-1683758342885-7acf321f5d53?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"></img></a>
                </div>
                <div>
